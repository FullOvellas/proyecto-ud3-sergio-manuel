...
- **Manuel Landín Gómez.**
    - Modelado e implementación del supuesto.
    - Diseño de utilidades de conexión `JpaUtil` y cifrado `Cipher`.
    - Diseño e implementación del sistema de daos y repositorios de acuerdo al patrón *Repository*.
    - Comunicación con Open Book API REST.
    - Diseño e implementación de la CLI de acuerdo al patrón MVC.
    - Implementación y conexión con base de datos en Azure.
    - Elaboración de [javadoc](https://srgottfried.github.io/vaultApp_documentation/).
...
- **Manuel Landín Gómez.**
  El aprendizaje por proyectos resulta un enfoque interesante cuando se aplica correctamente.
  Pero éste no ha sido el caso, y me limito a enumerar lo que creo, son flagrantes deficiencias
  en el planteamiento del proyecto en particular y de la asignatura en general:
    1. Se ha optado por un método en el que las clases teóricas han desaparecido casi completamente,
       dejando al alumno a merced de un desafío como es un proyecto de este tipo, sin herramientas para afrontarlo.
    2. No se ha dado bibliografía complementaria, webgrafía o contenido adecuado para todos los conceptos que se han
       manejado más allá de un resumen a menudo incompleto y del todo insuficiente.
    3. Se han perdido numerosas horas de clase en actividades improductivas o tangenciales a la asignatura, afectando
       directamente al tiempo efectivo para desarrollar los contenidos necesarios para afrontar el proyecto.
    4. El marco de tiempo elegido para desarrollar el proyecto ha sido simplemente inadecuado: las dos semanas en las
       que se concentran los exámenes trimestrales.
    5. Los requisitos del trabajo son obscenos para el tiempo asignado. Además, las calificaciones académicas son
       completamente
       injustas, dando lugar a una situación en la que contenidos "extra" no explicados conforman parte de la puntuación
       base.

  A pesar de todas estas circunstancias, y conscientes de que estas situaciones se presentan en el mercado
  laboral,
  hemos afrontado este proyecto de la mejor manera posible. El trabajo en equipo ha resultado determinante para cumplir
  con los objetivos dentro del tiempo, compartir planteamientos interesantes y propuestas efectivas. El desarrollo del
  proyecto
  a través de GitHub ha sido toda una experiencia; un recurso que hasta el momento nos resultaba de ayuda ahora se
  convierte en imprescindible para el trabajo en equipo.
  Por otro lado, y de manera inevitable, se han adquirido destrezas en el framework Hibernate la aplicación
  de patrones de diseño como MVC, DAO, Repository, Singleton, Builder, etc.

En resumen, la valoración del proyecto no es positiva en su planteamiento desde la perspectiva docente,
pero sí ha resultado muy positivo desde la perspectiva del trabajo en equipo,
la utlización de recursos nuevos como Hibernate o Azure, y el uso sistemático y estricto de
GitHub.
